...
class HotdogOrNotDataset(Dataset):
    def __init__(self, folder, aug=None, transform=None):
        self.folder = folder
    ...
    def __getitem__(self, index):        
        ...
        if self.aug:
            ...
            img = Image.fromarray(self.aug(**data)['image'])
...
def visualize_samples(dataset, indices, plt, title=None, count=10, random=True):
